@sanity
Feature: Onboard a product onboarding application with 2 products FCC&FCM and hierarchy as Parent Group


  Scenario Outline: Create an application with 2 products FCC&FCM and Withenrichment details
  ...
  Scenario Outline: Create an application with 2 products FCC&FCM and enrichment details and hierarchy as Parent Group
    Given a product onboarding application which is at Input stage
    And a product onboarding web portal for OPMAKER role
    When staff user logs in with the role
    When user selects the new application
