@sanity
Feature: Onboard a product onboarding application with 2 products FCC&FCM and hierarchy as Customer Group

  Scenario Outline: Create an application with 2 products FCC&FCM and enrichment details
  ...
  Scenario: View the no of APIs at Handoff stage of a product onboarding application
    ...
    Then party provision,party enrichment for Cash Management and party enrichment for Corporate Channels APIs should be visible
  ...
  Scenario Outline: Verify the completed stage of a product onboarding application
    ...
    And a product onboarding web portal for OPCHECKER role
    When staff user logs in with the role
    And user post the 3request id of customer group for integration api <testcase>
...
@1
  Scenario Outline: Create an application with 2 products FCC&FCM and enrichment details hierarchy group as Customer Group 'Is your Parent a transactional entity?' question as No and selects 'Do you want to create a Party Group for your Parent Entity?' as Yes
    Given a product onboarding application which is at Input stage
    And a product onboarding web portal for OPMAKER role
    When staff user logs in with the role
    When user selects the new application
  ...
  Scenario Outline: Verify data on view of full application for the saved application with all 4 products with enrichment details for Parent Hierarchy 'Is your Parent a transactional entity?' question as No and selects 'Do you want to create a Party Group for your Parent Entity?' as Yes
    ...
    And all the entered details should be displayed as filled on view of full application for product as Cash Management with enrichment details <testcase>
...
#    And filled parent party group details for customer group should be displayed on view
  ...
  Scenario Outline: Create an application with 2 products FCC&FCM and enrichment details with customer grp hierarchy Is your Parent a transactional entity?' question as No and selects 'Do you want to create a Party Group for your Parent Entity?' as No
    Given a product onboarding application which is at Input stage
    And a product onboarding web portal for OPMAKER role
    When staff user logs in with the role
    When user selects the new application
  ...
  Scenario Outline: Verify data on edit of the saved application with 2 FCC&FCM products with enrichment details for Customer group hierarchy Is your Parent a transactional entity?' question as No and selects 'Do you want to create a Party Group for your Parent Entity?' as No
    Given a product onboarding application which is at Input stage
    And a product onboarding web portal for OPMAKER role
    When staff user logs in with the role
    And selects the application from My Pending Queue tab
...
#    And filled parent party group details for customer group should be displayed on view
  ...
  Scenario Outline: Create an application with 2 products FCC&FCM and enrichment details for customer grp 'Is your Parent a transactional entity?' question as Yes
    Given a product onboarding application which is at Input stage
    And a product onboarding web portal for OPMAKER role
    When staff user logs in with the role
    When user selects the new application
  ...
  Scenario Outline: Verify data on edit of the saved application with 2 products FCC&FCM with enrichment details for Customer group hierarchy 'Is your Parent a transactional entity?' question as Yes
    Given a product onboarding application which is at Input stage
    And a product onboarding web portal for OPMAKER role
    When staff user logs in with the role
    And selects the application from My Pending Queue tab
