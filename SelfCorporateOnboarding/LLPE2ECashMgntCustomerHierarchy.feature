Feature: Onboard a corporate as 'Limited Liability Partnership' through Customer Self Onboarding portal and link Cash Management product with Customer hierarchy

  Scenario Outline: Onboard a corporate as Limited Liability Partnership type and assign Cash Management product with Customer hierarchy
