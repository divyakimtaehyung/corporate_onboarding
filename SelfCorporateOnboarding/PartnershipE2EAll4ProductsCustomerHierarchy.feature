Feature: Onboard a corporate as 'Partnership' through Customer Self Onboarding portal and link all the 4 products with Customer hierarchy


  Scenario Outline: Onboard a corporate as Partnership type and assign all the 4 products with Customer hierarchy
