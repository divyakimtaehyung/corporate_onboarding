Feature: Onboard a corporate as 'Limited' through Customer Self Onboarding portal and link all the 4 products with Customer Group hierarchy


  Scenario Outline: Onboard a corporate as Limited type and assign all the 4 products with Customer Group hierarchy
