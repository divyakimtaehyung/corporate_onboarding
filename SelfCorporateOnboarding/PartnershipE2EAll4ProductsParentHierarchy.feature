Feature: Onboard a corporate as 'Partnership' through Customer Self Onboarding portal and link all the 4 products with Parent hierarchy

  Scenario Outline: Onboard a corporate as Partnership type and assign all the 4 products with Parent Group hierarchy
    Given Self Onboarding portal is accessible
    When a corporate is successfully onboarded as Partnership company type <testcase>
