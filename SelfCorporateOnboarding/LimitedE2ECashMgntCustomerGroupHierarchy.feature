Feature: Onboard a corporate as 'Limited' through Customer Self Onboarding portal and link Cash Management product with Customer Group hierarchy

  Scenario Outline: Onboard a corporate as Limited type and assign Cash Management product with Customer Group hierarchy
